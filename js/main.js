function imc() {
    ...
    let indice = (peso / (altura * altura))*10000
    ...
    if (indice <= 18) {
        ...
        document.getElementById("resultado").innerHTML = `<div class='alert alert-danger' role='alert'><strong>TTu indice de masa corporal es: Obesidad VI</strong></div>`
    } else {
...
function edades() {
    ...
    if (edad <= 12) {
        ...
        document.getElementById("resultado2").innerHTML = `<div class='alert alert-danger'>Error: Dijite bien los datos</div>`
    }
}
...
function tablaH() {
    ...
    if (sexo === "M") {
        ...
        document.getElementById("resultado3").innerHTML = `<div class='alert alert-danger'>Error: Dijite bien los datos</div>`
    }
}
